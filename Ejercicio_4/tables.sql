...
create table ejercicio4.jockey(
...
create table ejercicio4.corredores(
	nro_encuentro integer NOT NULL,
    nro_de_carrera integer NOT NULL,
...
insert into ejercicio4.jockey (nro_de_lic,nombre,categoria) values
	(1,'George','L1'),
    (2,'Javier','L1'),
    (3,'Nahuel','L2'),
    (123,'Agarrala','L1'),
...
insert into ejercicio4.encuentros (nro_encuentro,fecha,nombre_hipo) values
	(1,null,'San Isidro'),
    (2,null,'San Isidro'),
    (3,null,'San Isidro'),
    (4,null,'San Isidro'),
...
insert into ejercicio4.carreras (nro_encuentro,nro_de_carrera,tipo_de_pista,estado_de_pista) values
	(1,1,'Pasto','Bueno'),
    (2,1,'Pasto','Bueno'),
    (3,1,'Pasto','Bueno'),
    (4,1,'Pasto','Bueno'),
...
insert into ejercicio4.corredores (nro_encuentro,nro_de_carrera,andarivel,nombre_caballo,nro_de_lic,posicion) values
	(1,1,10,'Rosinante',1,2),
    (2,1,21,'Rosinante',1,3),
